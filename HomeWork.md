...
Подключимся к удаленному репозиторию на GitHub, по ссылке. Для этого синхронизируем наш VSCode с аккаунтом на GitHub.com. В терминале VSCode вставим команду *git push*   
### *git push*
